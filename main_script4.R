...
saveRDS(results_0, file.path(output_dir, "data_50_4_0.rds"))
...
saveRDS(results_05, file.path(output_dir, "data_50_4_05.rds"))
...
saveRDS(results_15, file.path(output_dir, "data_50_4_15.rds"))
...
saveRDS(results_25, file.path(output_dir, "data_50_4_25.rds"))
...
saveRDS(results_35, file.path(output_dir, "data_50_4_35.rds"))
